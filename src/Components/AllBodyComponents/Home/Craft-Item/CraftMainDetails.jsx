...
const CraftMainDetails = () => {

    const { updateTitle } = useContext(AuthContext);

    // Update Dynamic title Setup
    useEffect(() => {
        updateTitle('Craft Details | Craft Store');
    }, [updateTitle]);
    ...
    const { craftURL, itemName, Customization, email, shortdescription, price, rating, processing_time, stockStatus, subitemname, _id } = craft;
...
export default CraftMainDetails;